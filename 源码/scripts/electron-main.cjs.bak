...
function seedDefaults() {
  const defaults = [
    ['extractor','信息提取器','prep','deepseek','','https://api.deepseek.com/v1/chat/completions','deepseek-chat',0.1,4096,1,SYSTEM_PROMPTS.extractor,0,'[]'],
    ['extractor2','辅助提取器','prep','deepseek','','https://api.deepseek.com/v1/chat/completions','deepseek-chat',0.2,4096,1,SYSTEM_PROMPTS.extractor2,0,'[]'],
    ['debate_ai1','审查AI-1','debate','deepseek','','https://api.deepseek.com/v1/chat/completions','deepseek-chat',0.3,4096,1,SYSTEM_PROMPTS.debate_ai1,0,'[]'],
    ['debate_ai2','审查AI-2','debate','deepseek','','https://api.deepseek.com/v1/chat/completions','deepseek-chat',0.4,4096,1,SYSTEM_PROMPTS.debate_ai2,0,'[]'],
    ['debate_ai3','审查AI-3','debate','deepseek','','https://api.deepseek.com/v1/chat/completions','deepseek-chat',0.35,4096,1,SYSTEM_PROMPTS.debate_ai3,0,'[]'],
    ['integrator','辩论汇总员','debate_summarizer','deepseek','','https://api.deepseek.com/v1/chat/completions','deepseek-chat',0.1,4096,1,SYSTEM_PROMPTS.integrator,0,'[]'],
    ...
    ['final_integrator','最终报告员','summary','deepseek','','https://api.deepseek.com/v1/chat/completions','deepseek-chat',0.2,8192,1,SYSTEM_PROMPTS.final_integrator,0,'[]'],
  ];
